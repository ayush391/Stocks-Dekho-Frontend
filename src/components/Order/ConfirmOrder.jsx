    ...
    return (
        <Modal open={open}>
            <Slide direction='left' in={open}>
                {
                    showResult ? <OrderSuccessfull reviewOrder={reviewOrder} onClose={onClose} /> :
                        <Container maxWidth='sm'>
                            <Card sx={{ borderRadius: '20px' }}>
                                ...
                                <Typography textAlign='center' variant='h4' sx={{ marginY: '1rem' }}>Confirm {transactionType === 'buy' ? 'Buying' : 'Selling'}</Typography>
